...
class Canonical extends AbstractBlock
{
    ...
    public function getCanonicalPageUrl()
    {
        if ($this->getPage() && $this->_helper->isCanonicalUrlEnable()) {
            ...
            if ($url == "https://stage-toppik-au.cdecomstaging.com/home"){
            $url = "https://stage-toppik-au.cdecomstaging.com";
            }
            if ($url == "https://stage-toppik-au.cdecomstaging.com/amasty-faq-home-page"){
                $url = "https://stage-toppik-au.cdecomstaging.com/faqs";
            }
            return $url;
        } else {
            return false;
